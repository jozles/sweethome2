...
extern  int   nbfonct,faccueil,fdatasave,fdatana,fperiSwVal,fperiDetSs,fdone,fpericur,fperipass,fpassword,fusername,fuserref,fperitst,ffavicon,fthermoshow,fdatamail,fdatapar;
...
//  Serial.print((long)configEndOfRecord);Serial.print(" ");Serial.println((long)configBegOfRecord);
  ...
  fdatapar=(strstr(fonctions,"data_par__")-fonctions)/LENNOM;
...
void anTimersPrint()
{
  for(uint8_t nt=0;nt<NBTIMERS;nt++){
    ...
    Serial.print((analTimers[nt].cb & ANT_BIT_ENABLE));Serial.print(" ");Serial.print(analTimers[nt].dw);Serial.print(" ");
    /*
    Serial.print(timersN[nt].perm);Serial.print(" ");Serial.print(timersN[nt].curstate);Serial.print(" ");
    Serial.print(timersN[nt].cyclic_);Serial.print(" ");Serial.print(timersN[nt].forceonoff);Serial.print(" ");
    Serial.print(timersN[nt].hdeb);Serial.print(" ");Serial.print(timersN[nt].hfin);Serial.print(" ");
...
void anTimersInit()
{
  ...
  for(int ant=0;ant<NBANTIMERS;ant++){
    ...
    memset(analTimers[ant].dispo,0x00,6);
  }
}
